...
class breaker_data:
    def __init__(self):
        ...
        self.data_path = f"{self.basepath}/feeders_{self.name}_{now}.csv"
    ...
    def get_breaker_data_allfeeders(self, feeders_group_name):
...
data.get_breaker_data_allfeeders("PTN")