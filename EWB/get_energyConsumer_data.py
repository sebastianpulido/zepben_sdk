...
class energyConsumer_data:
    ...
    def __init__(self):
        ...
        self.recon_data_path = f"{basepath}/recon_{self.feeder_mrid}_{name}_{now}.csv"
        self.connections_path = f"{basepath}/{self.feeder_mrid}_{name}_connections_{now}.csv"
